...
window.Modernizr = function(n, t, i) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(n) {
        ...
        return i = s.call(arguments, 1), r = function() {
            var f, e, u;
            return this instanceof r ? (f = function() {}, f.prototype = t.prototype, e = new f, u = t.apply(e, i.concat(s.call(arguments))), Object(u) === u ? u : e) : t.apply(n, i.concat(s.call(arguments)))
        }, r
    });
    ...
    for (o in f) c(f, o) && (e = o.toLowerCase(), r[e] = f[o](), y.push((r[e] ? "" : "no-") + e));
    return r.addTest = function(n, t) {
        if (typeof n == "object")
            for (var u in n) c(n, u) && r.addTest(u, n[u]);
        else {
        ...
        return r
    }, l(""), a = b = null, r._version = "2.7.1", r._prefixes = v, r
}(this, this.document);
        ...
        u.prototype = {
            ...
            getComputedStyle: function(n) {
                var i = {},
                    f = {},
                    r, e, u, o;
                for (i = t.getComputedStyle(n, null), r = 0, e = i.length; r < e; r++) u = i[r], o = i.getPropertyValue(u), f[u] = o;
                return f
            },
            extractUrl: function(n) {
                return startRegex = /^url\(["']?/, endRegex = /["']?\)$/, n.replace(startRegex, "").replace(endRegex, "")
            },
            positionToNegativeMargin: function(n) {
                var t, i;
                return t = n.match(/^(-?\d+\S+)/)[0], i = n.match(/\s(-?\d+\S+)$/)[0], "margin:" + i + " 0 0 " + t
            },
            getBgSize: function(t, i) {
                var r, e, s, u, h, f, o;
                return r = new Image, r.src = t, i !== "auto" && i !== "cover" && i !== "contain" && i !== "inherit" && (o = n(this.element), e = r.width / r.height, u = parseInt((i.match(/^(\d+)px/) || [0, 0])[1]), f = parseInt((i.match(/\s(\d+)px$/) || [0, 0])[1]), s = o.height() * e, h = o.width() / e, u = u || s, f = f || h), u || f ? {
                    width: u,
                    height: f
                } : {
                    width: r.width,
            ...
            getBgParams: function(t) {
                var i = {},
                    r;
                return r = this.extractUrl(t.css("background-image")), bgSize = this.getBgSize(r, t.css("background-size")), offset = this.positionToNegativeMargin(t.css("background-position")), i.styles = this.getComputedStyle(t[0]), i.svg = n.extend({
                    url: r
                }, bgSize, {
                    offset: offset
                }), i
...
(function(n) {
    for (var t, i, f = document.getElementsByTagName("head")[0].style, u = "transformProperty WebkitTransform OTransform msTransform MozTransform".split(" "), r = 0; r < u.length; r++) f[u[r]] !== undefined && (t = u[r]);
    t && (i = t.replace(/[tT]ransform/, "TransformOrigin"), i[0] == "T" && (i[0] = "t"));
    eval('IE = "v"=="\v"');
    jQuery.fn.extend({
        rotate: function(t) {
            var u, r, f, i, e, o;
            if (this.length !== 0 && typeof t != "undefined") {
                for (typeof t == "number" && (t = {
                        angle: t
                    }), u = [], r = 0, f = this.length; r < f; r++) i = this.get(r), i.Wilq32 && i.Wilq32.PhotoEffect ? i.Wilq32.PhotoEffect._handleRotation(t) : (e = n.extend(!0, {}, t), o = new Wilq32.PhotoEffect(i, e)._rootObj, u.push(n(o)));
                return u
            }
        },
        getRotateAngle: function() {
            for (var t, i = [], n = 0, r = this.length; n < r; n++) t = this.get(n), t.Wilq32 && t.Wilq32.PhotoEffect && (i[n] = t.Wilq32.PhotoEffect._angle);
            return i
        },
        stopRotate: function() {
            for (var t, n = 0, i = this.length; n < i; n++) t = this.get(n), t.Wilq32 && t.Wilq32.PhotoEffect && clearTimeout(t.Wilq32.PhotoEffect._timer)
        }
    });
    ...
    Wilq32.PhotoEffect.prototype = {
        ...
        _Loader: function() {
            return IE ? function() {
                var n = this._img.width,
                    t = this._img.height,
                    i;
                for (this._imgWidth = n, this._imgHeight = t, this._img.parentNode.removeChild(this._img), this._vimage = this.createVMLNode("image"), this._vimage.src = this._img.src, this._vimage.style.height = t + "px", this._vimage.style.width = n + "px", this._vimage.style.position = "absolute", this._vimage.style.top = "0px", this._vimage.style.left = "0px", this._aspectW = this._aspectH = 1, this._container = this.createVMLNode("group"), this._container.style.width = n, this._container.style.height = t, this._container.style.position = "absolute", this._container.style.top = "0px", this._container.style.left = "0px", this._container.setAttribute("coordsize", n - 1 + "," + (t - 1)), this._container.appendChild(this._vimage), this._rootObj.appendChild(this._container), this._rootObj.style.position = "relative", this._rootObj.style.width = n + "px", this._rootObj.style.height = t + "px", this._rootObj.setAttribute("id", this._img.getAttribute("id")), this._rootObj.className = this._img.className, this._eventObj = this._rootObj; i = this._onLoadDelegate.shift();) this._handleRotation(i, !0)
            } : function() {
                var n, t;
        ...
        _animate: function() {
            var t = +new Date,
                ...
                r, n;
            i && !this._parameters.animatedGif ? clearTimeout(this._timer) : ((this._canvas || this._vimage || this._img) && (r = this._parameters.easing(0, t - this._animateStartTime, this._animateStartAngle, this._parameters.animateTo - this._animateStartAngle, this._parameters.duration), this._rotate(~~(r * 10) / 10)), this._parameters.step && this._parameters.step(this._angle), n = this, this._timer = setTimeout(function() {
                n._animate.call(n)
            }, 10));
...
function panelBind(n) {
    ...
    $("#tbBox").live({
        mousedown: function(n) {
            ...
            var t, i = $(document),
                r = function(n) {
                    return i.scrollTop(i.scrollTop() + t - n.pageY), !1
                };
            return $(this).css("cursor", "move"), t = n.pageY, $(this).bind("mousemove", r), !1
        },
        mouseup: function() {
    ...
    $("#tool-crop").click(function() {
        ...
        SMH.croping || (SMH.croping = !0, i = $.pb({
            ...
            head: !1,
            oBtnText: "確定",
            content: '<span>請調整方框來選擇裁切的區域！<\/span><br/><span>長寬比：<\/span><select id="aspectRatio"><option value="0">不限制<\/option><option value="1">正方形(1:1)<\/option><option value="2/3">長方形(2:3)<\/option><option value="3/4">長方形(3:4)<\/option><\/select><br><span>驗證碼：<\/span><input type="text" name="code" size="4" maxlength="4"/><img name="code" src="" width="50px" height="21px" style="vertical-align: top;" />',
            onCancel: function() {
                t.destroy();
                SMH.croping = !1;
            ...
            onOk: function() {
                ...
                return $.trim(r) != "" ? (t.setOptions({
                    allowMove: !1,
                    allowResize: !1
                }), t.focus(), $("#pb-crop >>> .pb-ok").remove(), i.setContent("<span>正在裁切圖片,請稍等...<\/span>"), $.extend(t.pos, {
                    cid: n.cid,
                    p: pVars.page,
                    code: r
                }), $.ajax({
                    ...
                    dataType: "json",
                    success: function(r) {
                        r.success ? (i.setContent('<span><a href="' + r.img + '" target="_blank">圖片裁切<\/a>完成！建議您分享圖片以便持久保存。<\/span><div class="bdsharebuttonbox" data-tag="share_crop"><a class="bds_mshare" data-cmd="mshare"><\/a><a class="bds_qzone" data-cmd="qzone" href="#"><\/a><a class="bds_tsina" data-cmd="tsina"><\/a><a class="bds_baidu" data-cmd="baidu"><\/a><a class="bds_renren" data-cmd="renren"><\/a><a class="bds_tqq" data-cmd="tqq"><\/a><a class="bds_more" data-cmd="more">更多<\/a><\/div>'), window._bd_share_main = null, window._bd_share_config = {
                            common: {
                                bdDesc: "hi，我正在對 " + n.bname + " - " + n.cname + " 第" + n.page + "頁漫畫截屏，快來manhuagui.com試試吧！",
                                bdPic: r.img,
                        ...
                        }, SMH.utils.bdShareLoad()) : i.setContent("<span>" + (r.errorMessage ? r.errorMessage : "裁切圖片失敗，請稍後重試！") + "<\/span>")
                    }
                })) : alert("請輸入驗證碼！"), !1
            }
    ...
    $("#tool-gray").click(function() {
        ...
        n ? ($(this).addClass("sel"), $("img[data-tag=mangaFile]").addClass("grayscale").gray()) : location.reload(!1)
    });
...
var servs = [{
    ...
    pfuncs = [{
        name: "雙擊",
        desc: '<strong>下一頁：<\/strong><span class="keyboard key-click"><\/span>雙擊鼠標左鍵',
        fn: function() {
        ...
        name: "單擊",
        desc: '<strong>下一頁：<\/strong><span class="keyboard key-click"><\/span>單擊鼠標左鍵<br /><strong>上一頁：<\/strong><span class="keyboard key-click"><\/span>單擊鼠標右鍵',
        fn: function() {
        ...
        name: "兩側",
        desc: '<strong>下一頁：<\/strong><span class="keyboard key-click"><\/span>單擊圖片右側<br /><strong>上一頁：<\/strong><span class="keyboard key-click"><\/span>單擊圖片左側',
        fn: function() {
            $("#tbBox").append('<div id="efpLeftArea" class="arrLeft" title="上一張" onclick="SMH.prev();"><\/div><div id="efpRightArea" class="arrRight" title="下一張" onclick="SMH.next();"><\/div>');
        ...
        name: "下拉",
        desc: '<strong>下一頁：<\/strong><span class="keyboard key-click"><\/span>鼠標滑輪下滾<br /><strong>上一頁：<\/strong><span class="keyboard key-click"><\/span>鼠標滑輪上滾',
        fn: function() {
            SMH.utils.moreLoad()
        }
    }],
...
SMH.utils = function() {
    ...
    return {
        ...
        addToFav: function(n, t) {
            ...
            try {
                document.all ? window.external.addFavorite(n, t) : window.sidebar ? window.sidebar.addPanel(t, n, "") : alert("您可以嘗試通過快捷鍵" + i + " + D 加入到收藏夾!")
            } catch (r) {
                alert("您可以嘗試通過快捷鍵" + i + " + D 加入到收藏夾!")
            }
        },
        ...
        getRandomIndex: function(n) {
            ...
            for (var r = Math.random(), u = i.length - 1, t = 0; t < u;)
                if (probe = Math.ceil((u + t) / 2), i[probe] < r) t = probe + 1;
                else if (i[probe] > r) u = probe - 1;
            else return probe;
        ...
        imgRender: function(n, t) {
            ...
            $(n).attr("imgw", i);
            u ? (i > $(window).width() - 20 ? $(n).width($(window).width() - 20) : i < $("#mangaBox").width() && $(n).width($("#mangaBox").width()), $("#tool-zoom").removeClass().addClass("sel fit").text("適應")) : r != 0 && ($(n).width(i + i * r / 100), $("#tool-zoom").text((r > 0 ? "+" : "-") + $.formatNumber(Math.abs(r), {
                format: "00"
            ...
            typeof $('[data-tag="mangaFile"]').rotate != "undefined" && ($('[data-tag="mangaFile"]').rotate(0), t ? SMH.rotate.init() : SMH.rotate.render())
        },
...
SMH.imgData = function() {
        return function(n) {
            ...
            function o(n) {
                ...
                return n.indexOf(t) >= 0 ? o.apply(this, arguments) : (f.push(t), t)
            }

            function c(n) {
                s() ? $("#checkAdult").length > 0 && !$.cookie(e) ? ($("#imgLoading").hide(), $("#efpRightArea,#efpLeftArea").hide(), $("#checkAdult").click(function() {
                    try {
                        $.cookie(e, 1, {
                            expires: 7,
                            path: "/"
            ...
            function s() {
                var n = "HX",
                    i, r;
                return typeof $.cookie != "undefined" && (n = $.cookie("country")), i = n != null && t.block_cc.indexOf(n) < 0, r = !navigator.cookieEnabled && t.block_cc == "", i || r
            }

            function i(n) {
                var u = pVars.manga.filePath + t.files[n],
                    i = [];
                for (var r in t.sl) i.push(r + "=" + t.sl[r]);
            ...
            return f.push(pVars.curHost), {
                ...
                preInit: function() {
                    if (SMH.utils.init(this), $.each(["bid", "cid", "len", "prevId", "nextId"], function(n, i) {
                            cInfo[i] = t[i]
                        }), $.cookie("country") != null) this.init();
                    else {
                        var n = this;
                ...
                getHost: function() {
                    ...
                    try {
                        ...
                        i == null ? (pVars.curServ = 0, SMH.store.set("imgServ", pVars.curServ)) : (n = parseInt(i), n >= 0 && n < servs.length && (pVars.curServ = n));
                        i = SMH.store.get("imgHost");
                        i == null ? (r = SMH.utils.getRandomIndex(servs[pVars.curServ].hosts), SMH.store.set("imgHost", r), pVars.curHost = r) : (n = parseInt(i), n >= 0 && n < servs[pVars.curServ].hosts.length && (pVars.curHost = n));
                        pVars.manga.filePath = SMH.utils.getPath(servs[pVars.curServ].hosts[pVars.curHost].h, t.path);
                        i = SMH.store.get("pageFunc");
                        i == null ? (u = sys.mobile ? 2 : 1, SMH.store.set("pageFunc", u), pVars.curFunc = u) : (n = parseInt(i), n >= 0 && n < pfuncs.length && (pVars.curFunc = n))
                    } catch (f) {}
                },
                writeList: function() {
                    var i, n, f, r, u;
                    ...
                    for (sys.mobile && (i[0] = ""), $(".support ul").append(i.join("")), pVars.page = this.getPage(), $("#page").html(pVars.page), i = [], u = 0; u < t.len; u++) i.push('<option value="' + (u + 1) + '"' + (u + 1 == pVars.page ? ' selected="selected"' : "") + ">第" + (u + 1) + "頁<\/option>");
                ...
                error: function(n) {
                    var e = this;
                    r < servs[pVars.curServ].hosts.length ? (u && clearTimeout(u), r == 0 ? pVars.curFile += "&_" + sys.tk : (pVars.curHost = o(f), pVars.manga.filePath = SMH.utils.getPath(servs[pVars.curServ].hosts[pVars.curHost].h, t.path), pVars.curFile = i(pVars.page - 1)), e.reload(n, pVars.curFile), r++) : ($("#imgLoading").hide(), $("#mangaBox").html('<span class="nopic">圖片載入失敗，請 " 按F5鍵刷新頁面 " 或 "切換服務器線路" ，如果依然不行，請 " 進行報錯，管理員會盡快解決 " :(<\/span>'))
                },
                reload: function(n, t) {
                    var r = this,
                        i = new Image;
                ...
                moreLoad: function(n) {
                    ...
                    function w() {
                        ...
                        return $("#mangaMoreBox img").each(function(n) {
                            if (i += $(this).height(), i > o) {
                                var f = r + n - 2;
                                return f = f > r ? f : r, u = f < t.files.length ? f : t.files.length - 1, !1
                            }
                        }), u
                    }
                    var l, e, f, r;
                    if (pVars.page != t.files.length && s()) {
                        ...
                        (function p() {
                            setTimeout(function() {
                                $("#imgPreLoad img").length > 0 ? (o = !0, h()) : p()
                            }, 1e3)
                        })();
                        f = pVars.page;
                        r = f;
                        setInterval(function() {
                            var n = w();
                            return n > f && (f = n, SMH.history.add({
                                bn: t.bname,
                                bid: t.bid,
                                cn: t.cname,
                                cid: t.cid,
        ...
        t.fn = t.prototype = {
            ...
            _init: function(i) {
                var u = n.extend({}, t.defaults, i || {}),
                    s = ['<div id="', u.id, '" class="pb">', u.head ? '<div class="pb-hd">' + (u.xBtn ? '<a class="pb-x" href="javascript:;" title="關閉">✕<\/a>' : "") + '<span class="pb-title">' + u.title + "<\/span><\/div>" : "", '<div class="pb-bd"><div class="pb-ct"><\/div>', u.foot ? '<div class="pb-ft">' + (u.cBtn ? '<a class="pb-btn pb-cl">' + u.cBtnText + "<\/a>" : "") + '<a class="pb-btn pb-ok">' + u.oBtnText + "<\/a><\/div>" : "", "<\/div><\/div>"].join(""),
                    f = n(s),
                    o = f.find(".pb-hd"),
                    e = f.find(".pb-ft"),
                    r = this;
                return r.$pb = f, r.$head = o, r.$foot = e, r.$xBtn = o.find(".pb-x"), r.$cont = f.find(".pb-ct"), r.$cBtn = e.find(".pb-cl"), r.$oBtn = e.find(".pb-ok"), r.$pb.appendTo(document.body), r.opts = u, r.offsetHeight = o.outerHeight() + e.outerHeight(), r._bindEvent(), r._setPbZindex(), r.resize(u.width, u.height), r.setContent(u.content), u.mask && r._setMask(), u.fixed || r.$pb.css("position", "absolute"), r.setPos(u.top, u.left), t.list[u.id] = r, r._focus(), r
            },
            _zindex: function() {
            ...
            _bindEvent: function(t) {
                ...
                i.$oBtn.length && i.$oBtn.click(function() {
                    var r = !0;
                    n.isFunction(t.onOk) && (r = t.onOk(), r != !1 && (r = !0));
                    r == !0 && i.dispose()
                });
            ...
            setPos: function(n, t) {
                ...
                return n === "c" && (n = r.height() - u.$pb.outerHeight(), n = n > 0 ? e + (n >> 1) - (n >> 3) : 0), t === "c" && (t = r.width() - u.$pb.outerWidth(), t = t > 0 ? f + (t >> 1) : 0), u.$pb.css({
                    top: n,
                    left: t
                }), u
            },
            ...
            dispose: function() {
                ...
                t.focus ? (t.focus.opts.mask ? r._setMaskZindex() : n("#pb-mask").hide(), n(".pb").last().css("z-index", r._zindex())) : n("#pb-mask").remove();
    ...
    function(n) {
        n.fn.center = function(t) {
            ...
            return this.each(function() {
                ...
                delete i.relative;
                i.position == "fixed" && n.browser.version == "6.0" && (i.marginTop += n(window).scrollTop(), i.position = "absolute", n(window).scroll(function() {
                    t.stop().animate({
...
SMH.pager = function(n) {
    ...
    var i = [],
        ...
        r = o();
    if (i.push('<a class="btn-red prev" onclick="SMH.prevC()" href="javascript:void(0);">上一章<\/a>'), n.cp === 0 ? i.push('<span class="disabled">上一頁<\/span>') : i.push('<a class="btn-red prev" href="javascript:SMH.utils.goPage(' + (pVars.page - 1) + ')">上一頁<\/a>'), r[0] > 0) {
        for (f = Math.min(n.nee, r[0]), t = 0; t < f; t++) u(t);
        n.nee < r[0] && i.push("<span>...<\/span>")
    }
    for (t = r[0]; t < r[1]; t++) u(t);
    if (r[1] < n.pc)
        for (n.pc - n.nee > r[1] && i.push("<span>...<\/span>"), e = Math.max(n.pc - n.nee, r[1]), t = e; t < n.pc; t++) u(t);
    return n.cp === n.pc - 1 ? i.push('<span class="disabled">下一頁<\/span>') : i.push('<a class="btn-red next" href="javascript:SMH.utils.goPage(' + (pVars.page + 1) + ')">下一頁<\/a>'), i.push('<a class="btn-red next" onclick="SMH.nextC()" href="javascript:void(0);">下一章<\/a>'), i.join("")
};
SMH.backtotop = function() {
    ...
    function i() {
        ...
        i = $(document).scrollTop();
        i > t ? n.show() : n.hide();
        sys.ie6 && (u = $(this).height(), n.css("top", i + u - 166))
    }
    var u = '<div class="backToTop"><a href="javascript:;" id="report" title="舉報報錯">舉報報錯<\/a><a href="javascript:;" id="backTop" title="返回頂部">回到頂部<\/a><\/div>',
        t, n;
    i();
...
SMH.feedback = {},
    function(n, t) {
        function i() {
            var n = [];
            return n.push('<div class="feedback"><form id="feedback"><h4 style="padding-top:10px;">請選擇問題的類型：<\/h4><ul id="fdType">'), t.each(u, function() {
                n.push('<li><label><input type="checkbox"  value="' + this + '" /> ' + this + "<\/label><\/li>")
            }), n.push("<\/ul>"), n.push("<h4>請輸入問題的描述：<span>(請輸入問題的詳細描述，以方便我們解決問題。您最多可輸入500字。)<\/span><\/h4>"), n.push('<textarea id="fdCont" maxlength="500" resizable="false"><\/textarea>'), n.push("<h4>留下您的聯繫方式：<span>(留下您的電子郵箱，方便客服與您解決問題。更有機會獲取禮品。)<\/span><\/h4>"), n.push('<input id="fdContact" class="fd-contact" type="textbox" >'), n.push("<\/form><\/div>"), n.join("")
        }
        ...
        function r() {
            ...
            }), i.length == 0) ? (alert("請選擇問題的類型"), !1) : t.trim(t("#fdCont").val()) == "" ? (alert("請輸入有關問題的描述"), t("#fdCont").focus(), !1) : t.trim(t("#fdContact").val()) == "" ? (alert("請留下您的聯繫方式"), t("#fdContact").focus(), !1) : (n = {}, n.errors = i.join(","), n.bookid = cInfo.bid, n.chapterid = cInfo.cid, n.content = t("#fdCont").val(), n.contact = t("#fdContact").val(), n.url = window.location.href, n.img = t("#mangaFile").attr("src"), t.ajax({
                type: "POST",
                url: "/tools/feedback.ashx",
                data: n,
                success: function(n) {
                    n.success ? alert("感謝您的提交") : alert("抱歉，內容提交失敗，請稍後重試")
                },
                dataType: "json"
            }), !0)
        }
        var u = ["漫畫要更新啦", "圖片不顯示", "簡介有誤", "章節錯誤", "章節內圖片順序錯誤"];
        n.open = function() {
            t.pb({
                title: "遇到了問題，沒關係，請報錯給我們",
                width: 600,
                height: 320,
                content: i(),
                cBtnText: "取消提交",
...
SMH.chapter = function() {
    ...
    function r(r) {
        ...
        setTimeout(function() {
            t && clearTimeout(t);
            r === 1 ? cInfo.nextId == 0 ? (i.hide(), i.alert(cInfo.finished == 0 ? n.tip_last : n.tip_end)) : location.href = "/comic/" + cInfo.bid + "/" + cInfo.nextId + ".html" : cInfo.prevId == 0 ? i.hide(n.tip_first, 2e3) : location.href = "/comic/" + cInfo.bid + "/" + cInfo.prevId + ".html"
        }, 2e3)
    }
    var n = {
            url: "/tools/chapter.ashx",
            timeout: 1e4,
            tip_ready_next: "本章節已閱覽完畢，是否進入下一章節？",
            tip_next: "正在進入下一章節，請稍候....",
            tip_ready_prev: "這是本章節的第一頁，是否進入上一章節？",
            tip_prev: "正在返回上一章節，請稍候....",
            tip_last: "這是本作品最新一章，敬請關注下次更新。",
            tip_end: "漫畫已完結，這是本作品最後一章了。",
            tip_first: "這是本作品第一章，沒有上一章哦。",
            tip_failed: "抱歉，章節獲取失敗，請稍後重試。"
        },
        t, i = function() {
            var n = !1;
            return {
                ...
                show: function(t) {
                    n === !1 && (this.append(), $("#smh-msg-box").show().center());
                    $("#smh-msg-box").show();
                ...
                alert: function(n) {
                    $.pb({
                        ...
                        width: 580,
                        height: 100,
                        content: '<div class="tip-alert"><i><\/i>' + n + '<br /><a href="/comic/' + cInfo.bid + '/">返回目錄<\/a><\/div>',
                        foot: !1
                    })
                }
            }
    ...
    return {
        ...
        confirm: function(t) {
            ...
            $.pb({
                ...
                width: 580,
                height: 100,
                content: '<div class="tip-alert"><i><\/i>' + (t === 1 ? n.tip_ready_next : n.tip_ready_prev) + '<br /><a href="/comic/' + cInfo.bid + '/">返回目錄<\/a><\/div>',
                foot: !0,
                oBtnText: "是的。我知道了，直接進入" + (t === 1 ? "下" : "上") + "一章節。",
                cBtn: !1,
                onOk: function() {
                    r(t)
                }
...
SMH.shortcuts = function() {
    function u() {
        if (n == 0) {
            var t = [];
            return t.push('<div class="tip-shortcuts" id="tip-shortcuts">'), t.push('<div id="tip-close"><a title="關閉" href="javascript:void(0);">關閉<\/a><\/div>'), t.push("<i><i><\/i><\/i>"), t.push('<div class="shadow tip-cont"><ol>'), t.push(pVars.shortcuts.tip()), t.push("<\/ol>"), t.push("<\/div>"), t.push("<\/div>"), t.join("")
        }
        return ""
    }
    ...
    return {
        init: function() {
            ...
            t == 1 ? (i(), $("#tip-shortcuts").show().delay(3e3).hide(500), SMH.store.set("tip-again", 0)) : r()
        }
    }
}();
    ...
    function t() {
        if (n == 0) {
            var i = location.href.replace(/(www|tw)\.ikanman\.com/, "m.ikanman.com").replace(/\_p([0-9]+)\.html/g, ".html") + "#p=" + pVars.page,
                t = [];
            return t.push('<div class="tip-shortcuts" id="tip-qr">'), t.push("<i><i><\/i><\/i>"), t.push('<div class="shadow tip-cont"><ol>'), t.push('<li><div style="float:left;"><strong>電腦版<\/strong><br><img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&qzone=6&data=' + encodeURIComponent(location.href) + '" /><\/div>'), t.push('<strong>手機版<\/strong><br><img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&qzone=6&data=' + encodeURIComponent(i) + '" /><\/li>'), t.push("<li>用手機掃描二維碼<br />把本頁掃到手機上繼續閱讀<\/li>"), t.push("<\/ol>"), t.push("<\/div>"), t.push("<\/div>"), t.join("")
        }
        return ""
    }

    function i() {
        n == 0 && ($("#tool-qr").after(t()), n = 1)
    }
...
SMH.zoomtool = function() {
    function i() {
        if (n == 0) {
            var t = [];
            return t.push('<div class="tip-shortcuts" id="tip-zoom">'), t.push('<div id="tip-close1"><a title="關閉" href="javascript:void(0);">關閉<\/a><\/div>'), t.push("<i><i><\/i><\/i>"), t.push('<div class="shadow tip-cont"><ol>'), t.push('<li><label><input type="checkbox" ' + (SMH.store.get("autosize") ? "checked" : "") + "/> 自適應寬度<\/label><\/li>"), t.push('<li>縮放圖片<\/li><li><div class="slider-cont"><input id="slider-zoom" type="slider" value="' + SMH.store.get("zoom") + '" /><\/div><\/li>'), t.push("<\/ol>"), t.push("<\/div>"), t.push("<\/div>"), t.join("")
        }
        return ""
    }

    function r() {
        n == 0 && ($("#tool-zoom").after(i()), $("#tip-close1 a").click(function(n) {
            n.stopPropagation();
            $("#tip-zoom").hide();
            t()
        }), u(), n = 1)
        ...
        $("#slider-zoom").slider({
            ...
            onstatechange: function(n) {
                ...
                i.is(":checked") || (t = parseInt(n), Math.abs(t) < 100 && (SMH.store.set("zoom", t), r = $(this), $("#mangaBox img,#mangaMoreBox img").each(function(n, i) {
                    ...
                    $(i).width(r + r * t / 100);
                    t == 0 ? ($("#tool-zoom").removeClass("sel"), $("#tool-zoom").text("縮放")) : $("#tool-zoom").text((t > 0 ? "+" : "-") + $.formatNumber(Math.abs(t), {
                        format: "00"
...
SMH.suggest = function(n) {
    function l() {
        if (i >= 0) window.location.href = $("#ret" + i).attr("rel");
            ...
            if (n == u || n == "") return $("#" + t.key).focus(), window.alert("請輸入要你要搜索的漫畫"), !1;
    ...
    function p(n, t) {
        var r = [],
            u, i;
        for (u in n) i = n[u], r.push('<li id="ret' + u + '" rel="' + i.u + '" title="' + i.t + '" onclick="location.href=\'' + i.u + "'\">"), r.push(i.s == "1" ? "<em>已完結<\/em>" : "<span>" + i.ct + "<\/span>"), r.push('<a href="' + i.u + '">' + i.t.replace(new RegExp("(" + t + ")", "gi"), "<strong>$1<\/strong>") + "<\/a> <i>[" + i.a.replace(new RegExp("(" + t + ")", "gi"), "<strong>$1<\/strong>") + "]<\/i>"), r.push("<\/li>");
        return r.join("")
    }
    ...
    function v() {
        ...
        o = window.setTimeout(function() {
            var n = $.trim($("#" + t.key).val());
            s != n && (s = n, n != "" ? y(n) : (i = -1, r = 0, e(), $("#" + t.result).html("")))
        }, t.delay)
    }

    function c() {
        if (i < -1 ? i = r - 1 : i >= r && (i = -1), $("#" + t.result + " li").removeClass("selected"), i == -1) $("#" + t.key).val(s);
        else {
            var n = $("#ret" + i);
            $(n).addClass("selected");
    ...
    return $("#" + t.key).val(u).css("color", "#ccc"),
        function() {
            ...
            $("#" + t.key).keyup(function(n) {
                if (n.stopPropagation(), n.keyCode == 13) l();
                else {
...
SMH.history = function() {
    function t(n) {
        ...
        } else e - i < 6e4 ? (u = Math.ceil((e - i) / 1e3), t.push(u, "秒前")) : (u = Math.ceil((e - i) / h), u == 1 ? t.push(Math.floor((e - i) % h / 6e4), "分鐘前") : t.push("今天 ", f(r.getHours()), ":", f(r.getMinutes())));
        return t.join("")
    }
    var n = {
        maxLen: 50,
    ...
    return {
        ...
        add: function(t) {
            ...
            }), n.cvalue.push(t), n.len++, n.len > n.maxLen && (n.cvalue.splice(0, n.len - n.maxLen + 1), n.len = n.maxLen));
        ...
        remove: function(t, i) {
            if (n.cvalue.splice(t, 1), n.len--, n.len <= 0 ? SMH.store.remove(n.cname) : SMH.store.set(n.cname, n.cvalue), $(i).parent().hide(200), n.len <= 0) {
                $("#hList").html('<div class="hNone">暫時沒有觀看記錄!<\/div>');
                return
            }
        ...
        format: function() {
            ...
            n.len > 0 && $.each(n.cvalue, function(r, u) {
                var f = [];
                f.push('<li><a class="hDelete fr" title="刪除" rel="' + r + '"><span>刪除<\/span><\/a>');
                f.push('<a class="book" href="/comic/' + u.bid + '/">' + u.bn + '<\/a> <em>/<\/em> <a href="/comic/' + u.bid + "/" + u.cid + '.html" class="red">' + u.cn + "<\/a>");
                f.push('<div><span class="fr" style="line-height:1.6em;"><a href="/comic/' + u.bid + "/" + u.cid + ".html" + (u.p == 1 ? "" : "#p=" + u.p) + '">繼續觀看<\/a><\/span>');
                r == n.cvalue.length - 1 ? f.push('<span class="hTime">正在瀏覽觀看……<\/span>') : f.push('<span class="hTime">上次於 ' + t(u.t) + " 觀看<\/span>");
                f.push("<\/div><\/li>");
                i.push(f.join(""))
            });
            u = this;
            r = n.len;
            r == 0 ? $("#hList").html('<div class="hNone">暫時沒有觀看記錄!<\/div>') : ($("#hList").html('<div class="hList"><ul>' + i.reverse().join("") + "<\/ul><\/div>"), $(".hList li").hover(function() {
...
SMH.rotate = function() {
    function i() {
        t % 360 > 0 ? ($("#tool-rotate").addClass("sel"), $("#tool-rotate").text(t % 360)) : ($("#tool-rotate").removeClass("sel"), $("#tool-rotate").text("旋轉"))
    }
...
$(function() {
    $(".nav-sec").html('<ul><li><a href="/list/japan/">日本<\/a><\/li><li><a href="/list/hongkong/">港臺<\/a><\/li><li><a href="/list/other/">其它<\/a><\/li><li><a href="/list/europe/">歐美<\/a><\/li><li><a href="/list/china/">內地<\/a><\/li><li><a href="/list/korea/">韓國<\/a><\/li><li><a href="/list/rexue/">熱血<\/a><\/li><li><a href="/list/maoxian/">冒險<\/a><\/li><li><a href="/list/mohuan/">魔幻<\/a><\/li><li><a href="/list/shengui/">神鬼<\/a><\/li><li><a href="/list/gaoxiao/">搞笑<\/a><\/li><li><a href="/list/mengxi/">萌系<\/a><\/li><li><a href="/list/aiqing/">愛情<\/a><\/li><li><a href="/list/kehuan/">科幻<\/a><\/li><li><a href="/list/mofa/">魔法<\/a><\/li><li><a href="/list/gedou/">格鬥<\/a><\/li><li><a href="/list/wuxia/">武俠<\/a><\/li><li><a href="/list/jizhan/">機戰<\/a><\/li><li><a href="/list/zhanzheng/">戰爭<\/a><\/li><li><a href="/list/jingji/">競技<\/a><\/li><li><a href="/list/tiyu/">體育<\/a><\/li><li><a href="/list/xiaoyuan/">校園<\/a><\/li><li><a href="/list/shenghuo/">生活<\/a><\/li><li><a href="/list/lizhi/">勵志<\/a><\/li><li><a href="/list/lishi/">歷史<\/a><\/li><li><a href="/list/weiniang/">偽娘<\/a><\/li><li><a href="/list/zhainan/">宅男<\/a><\/li><li><a href="/list/funv/">腐女<\/a><\/li><li><a href="/list/danmei/">耽美<\/a><\/li><li><a href="/list/baihe/">百合<\/a><\/li><li><a href="/list/hougong/">後宮<\/a><\/li><li><a href="/list/zhiyu/">治癒<\/a><\/li><li><a href="/list/meishi/">美食<\/a><\/li><li><a href="/list/tuili/">推理<\/a><\/li><li><a href="/list/xuanyi/">懸疑<\/a><\/li><li><a href="/list/kongbu/">恐怖<\/a><\/li><li><a href="/list/sige/">四格<\/a><\/li><li><a href="/list/zhichang/">職場<\/a><\/li><li><a href="/list/zhentan/">偵探<\/a><\/li><li><a href="/list/shehui/">社會<\/a><\/li><li><a href="/list/yinyue/">音樂<\/a><\/li><li><a href="/list/wudao/">舞蹈<\/a><\/li><li><a href="/list/zazhi/">雜誌<\/a><\/li><li><a href="/list/heidao/">黑道<\/a><\/li><li><a href="/list/shaonv/">少女<\/a><\/li><li><a href="/list/shaonian/">少年<\/a><\/li><li><a href="/list/qingnian/">青年<\/a><\/li><li><a href="/list/ertong/">兒童<\/a><\/li><li><a href="/list/tongyong/">通用<\/a><\/li><\/ul>');
